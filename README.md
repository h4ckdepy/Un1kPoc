...
在最近的护网里，我发现我和我的同事经常在做一件事。搜集靶标相关资产，找到可以用nday打的资产，找到nday的poc，利用。如果我能够把这个流程简化成搜索漏洞，搜索资产，点击利用，那么就可以为我节省很多时间。所以我才会去花一个月的时间编写这个工具。

工具的可用性是随时间增长的,换句话说,只要能够持续维护下去。后续对于漏洞利用,只需要一个Un1kPoc就行了。

只要你想,他可以是市面上任何的OA测试工具、CMS测试工具,也可以是资产收集工具,半自动化漏洞利用工具。市面上的测试工具很多,我也不想重复造轮子。只是看了很多工具，都在某些方面无法满足我自己的需求。

## Update

2022-08-30 更新至版本V2.1.0

2022-08-30 更新官方文档

2022-08-29 更新至版本V2.0.5

2022-08-28 更新至版本V2.0.1 旧版本已不可使用
